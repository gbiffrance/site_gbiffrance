(function ($) {
  ...
  Drupal.theme.prototype.viewsSlideshowControlsPause = function () {
   // return '<img alt="test" src="http://asphalt-tuning.com/publicity/90.gif" />';
  };

  // Theme the pause control.
  Drupal.theme.prototype.viewsSlideshowControlsPlay = function () {
     //  return $this.'<img alt="test" src="http://asphalt-tuning.com/publicity/90.gif" />';
   // return Drupal.t('Pause');
    // $(".views-slideshow-controls-text-pause-processed").append( "<p>Test</p>" );
  };
